-- ogrinalna lokalizacja pliku w systemie Windows to profil użytkownika; plik ma się nazywać
-- .wezterm.lua

local wezterm = require 'wezterm'
local config = wezterm.config_builder()

-- Domyślnie uruchamiaj PowerShell (dla Windows / Yazi / Scoop)
config.default_prog = { 'powershell.exe', '-NoLogo' }

-- Dodaj WSL jako opcjonalny profil w menu (launch menu)
config.launch_menu = {
  {
    label = 'WSL (Ubuntu)',
    args = { 'wsl.exe' },
